...
# -*- encoding: utf-8 -*-
'''
@File    :   02-train-lenet.py
@Time    :   2020/02/19 10:59:31
@Author  :   liululu
@brief   :   人民币分类训练
...
from process.model.lenet import LeNet
from process.tools.my_dataset import RMBDataset
